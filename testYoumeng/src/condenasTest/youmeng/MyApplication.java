		        ...
		        new Handler(getMainLooper()).post(new Runnable() {
		            ...
		            public void run() { 
		               ...
		               boolean isClickOrDismissed = true;
		                ...
		                System.out.println("------------------------------------234234--------------------------------"+msg.custom);
		            }
		        });
		    }
...
//				intent2.putExtra("json", msg.custom);
				intent.putExtra("json", msg.custom);
				IntentManager.getIntentManager().setIntent("MainActivity", intent);
//				intent2.setAction("GN");
//				// 发
